---
name: ai-harden
description: Audit and harden LLM/AI data flows against OWASP LLM Top 10, MITRE ATLAS, and multilingual / polyglot adversarial input. Six-axes assessment including prompt injection, system-prompt leakage, insecure output handling, BudgetGate, tool-exposure SSRF, and polyglot adversarial input. Invoke as `/ai-harden [scope]` or via natural language.
user-invocable: true
---
